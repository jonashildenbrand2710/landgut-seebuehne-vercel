    ...
    <article className={styles.page}>
      ...
      <section className={styles.ctaSection} id="kennenlernen">
        ...
        <div className={styles.ctaCopyPane}>
          ...
          <h2>Wie wird aus der Idee euer Hochzeitstag?</h2>
          <p>
            Wenn sich die Seebühne für euch richtig anfühlt, lernt uns und das Landgut persönlich
            kennen. Wählt auf der nächsten Seite zwischen einem ersten Telefonat und einer
            Besichtigung vor Ort.
          </p>
          <ul>
            <li><Check aria-hidden="true" size={17} /> offene Fragen persönlich sortieren</li>
            <li><Check aria-hidden="true" size={17} /> das passende Gesprächsformat wählen</li>
            <li><Check aria-hidden="true" size={17} /> direkt einen freien Termin finden</li>
          </ul>
          <div className={styles.ctaActions}>
            <Link className={styles.primaryButton} href={siteConfig.bookingUrl}>
              Telefonat oder Besichtigung wählen
      ...
      <section className={styles.mappeCta} aria-label="Nächsten Schritt wählen">
        <div>
          <span>Euer nächster Schritt</span>
          <p>Wählt zwischen einem ersten Telefonat und einer persönlichen Besichtigung.</p>
        </div>
