...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Dornrose – Hochzeitsmappe am See",
    description:
      "Der Online-Hochzeitsbegleiter des Landgut Seebühne mit Inspiration, Ablaufideen und Einblicken in die Location am See.",
    url: "/hochzeitsmappe",
    images: [
      {
        url: "/images/site/hero-brautpaar-steg-am-see.jpg",
  ...
  return (
    <article className={styles.page}>
      <PageJsonLd
        path="/hochzeitsmappe"
        title="Dornrose – Hochzeitsmappe am See"
        description="Der persönliche Online-Hochzeitsbegleiter des Landgut Seebühne mit Inspiration, Ablaufideen und Einblicken in die Location am See."
        breadcrumbs={[
      ...
      <section className={styles.ctaSection} id="kennenlernen">
        ...
        <div className={styles.ctaCopyPane}>
          ...
          <h2>Was kostet eure Hochzeit an der Seebühne?</h2>
          <p>
            Fordert unsere Übersicht mit Preisen und Leistungsbausteinen an und erhaltet sie direkt
            per E-Mail. So könnt ihr in Ruhe prüfen, welche Möglichkeiten zu eurem Fest passen. Wenn
            sich die Seebühne danach weiterhin richtig anfühlt, ist eine persönliche Besichtigung
            der nächste Schritt.
          </p>
          <ul>
            <li><Clock3 aria-hidden="true" size={17} /> die Übersicht direkt per E-Mail erhalten</li>
            <li><Check aria-hidden="true" size={17} /> Preise und Leistungsbausteine in Ruhe ansehen</li>
            <li><MapPin aria-hidden="true" size={17} /> danach bewusst über eine Besichtigung entscheiden</li>
          </ul>
          <div className={styles.ctaActions}>
            <Link
              className={styles.primaryButton}
              href="/intern/hochzeitsmappe-alt?preise=1#mappe-form"
            >
              Preise anfordern
              <ArrowRight aria-hidden="true" size={18} />
            </Link>
            <a className={styles.secondaryButton} href={siteConfig.bookingUrl}>
              Besichtigung planen
              <ArrowRight aria-hidden="true" size={18} />
            </a>
          </div>
      ...
      <section className={styles.mappeCta} aria-label="Preise und Leistungsbausteine anfordern">
        <div>
          <span>Preise &amp; Leistungsbausteine</span>
          <p>Erhaltet die Übersicht direkt per E-Mail und prüft in Ruhe, was zu eurem Fest passt.</p>
        </div>
        <Link href="/intern/hochzeitsmappe-alt?preise=1#mappe-form">
          Preise anfordern
          <ArrowRight aria-hidden="true" size={18} />
        </Link>
      </section>
