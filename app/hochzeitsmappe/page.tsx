...
export const metadata: Metadata = {
  ...
  description:
    "Sichert euch den persönlichen Online-Zugang zur Hochzeitsmappe der Seebühne mit Einblicken in Location, Ablauf und Hochzeitstag.",
  alternates: {
    canonical: "/hochzeitsmappe"
  },
  openGraph: {
    title: "Hochzeitsmappe der Seebühne",
    description:
      "Persönlicher Online-Hochzeitsbegleiter für eure Hochzeit am See.",
    url: "/hochzeitsmappe",
    images: [
      {
        url: imageLibrary.availability.src,
        alt: imageLibrary.availability.alt
      }
    ]
  }
};
  ...
  return (
    <article className="mappe-page">
      <PageJsonLd
        path="/hochzeitsmappe"
        title="Hochzeitsmappe der Seebühne"
        description="Sichert euch den persönlichen Online-Zugang zur Hochzeitsmappe der Seebühne mit Einblicken in Location, Ablauf und Hochzeitstag."
        breadcrumbs={[
      ...
      <section className="mappe-form-section">
        ...
        <div className="section-inner mappe-form-grid">
          <div className="mappe-final-copy">
            ...
            <p className="eyebrow">Persönlicher Online-Zugang</p>
            <h2>Öffnet jetzt eure Hochzeitsmappe.</h2>
            <p>
              Nach dem kurzen Formular öffnet sich die Mappe sofort im Browser. Zusätzlich
