...
export const sitePages: SitePage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Google Ads Conversion Tracking (nur mit Einwilligung)",
        text:
          "Nur wenn ihr im Cookie-Banner auf \"Einverstanden\" klickt, laden wir den Google Tag (gtag.js) der Google Ireland Limited (Gordon House, Barrow Street, Dublin 4, Irland) für Google Ads Conversion Tracking. Damit messen wir, ob eine Anzeige zu einer Terminbuchung oder einer Anfrage geführt hat; dabei können Cookies gesetzt und Klick-Kennungen (z. B. gclid) verarbeitet werden (Rechtsgrundlage: eure Einwilligung, Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG).\nWir verwenden den Google Consent Mode (Version 2): Ohne eure Einwilligung sind alle vier Consent-Signale (ad_storage, analytics_storage, ad_user_data, ad_personalization) auf \"denied\" gesetzt und es werden keine Daten an Google übertragen; der Google Tag wird erst nach eurer Einwilligung geladen.\nBei erfolgreichen Anfragen oder Terminbuchungen können zusätzlich über Enhanced Conversions gehashte (verschlüsselt umgewandelte) Kontaktdaten (E-Mail-Adresse, Telefonnummer) an Google übertragen werden, um Conversions genauer zuzuordnen. Dabei können Daten in die USA übermittelt werden; Google LLC ist nach dem EU-US Data Privacy Framework zertifiziert.\nIhr könnt eure Einwilligung jederzeit über den Link \"Cookie-Einstellungen\" im Footer ändern oder widerrufen. Ohne Einwilligung bleibt das Tracking vollständig deaktiviert."
      },
      {
        title: "Speicherdauer",
        text:
