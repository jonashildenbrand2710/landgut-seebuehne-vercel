...
export const homepageHeroMobileImage = {
  src: "/images/site/hero-brautpaar-steg-am-see-mobile-ai-v5-4k-corrected.jpg",
  alt: "Brautpaar mit Schirm auf einem Holzsteg am See des Landgut Seebühne"
} as const;
...
export const sitePages: SitePage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "TikTok Pixel und Events API (nur mit Einwilligung)",
        text:
          "Nur wenn ihr im Cookie-Banner auf \"Einverstanden\" klickt, laden wir den TikTok Pixel der TikTok Technology Limited (10 Earlsfort Terrace, Dublin, D02 T380, Irland). Der Pixel kann Marketing-Cookies und Kennungen wie _ttp und ttclid verwenden, um die Wirkung unserer TikTok-Anzeigen zu messen und Kampagnen zu optimieren (Rechtsgrundlage: eure Einwilligung, Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG).\nWenn über unseren Termin-Funnel ein telefonisches Erstgespräch oder eine Besichtigung erfolgreich gebucht wurde, können wir dasselbe Ereignis zusätzlich über die TikTok Events API direkt von unserem Server an TikTok übermitteln. Dabei können Ereignis-ID, Zeitpunkt, Quell-URL, IP-Adresse, Browserinformationen, TikTok-Klick- und Cookie-Kennungen sowie mit SHA-256 gehashte E-Mail-Adresse und Telefonnummer übertragen werden. Die gemeinsame Ereignis-ID verhindert eine doppelte Zählung von Pixel- und Serverereignis. Die Hochzeitsmappe ist von diesem TikTok-Ereignis ausgenommen.\nTikTok kann Daten auch außerhalb des Europäischen Wirtschaftsraums verarbeiten und verwendet dafür nach eigenen Angaben geeignete Übermittlungsmechanismen wie Standardvertragsklauseln. Ihr könnt eure Einwilligung jederzeit über den Link \"Cookie-Einstellungen\" im Footer ändern oder widerrufen. Ohne Einwilligung bleiben sowohl TikTok Pixel als auch TikTok Events API deaktiviert."
      },
      {
        title: "Speicherdauer",
        text:
